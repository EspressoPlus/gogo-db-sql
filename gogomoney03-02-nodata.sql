...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema gogomoney03-02
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema gogomoney03-02
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `gogomoney03-02` DEFAULT CHARACTER SET utf8 ;
USE `gogomoney03-02` ;

-- -----------------------------------------------------
-- Table `gogomoney03-02`.`category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gogomoney03-02`.`category` (
...
-- -----------------------------------------------------
-- Table `gogomoney03-02`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gogomoney03-02`.`user` (
...
-- -----------------------------------------------------
-- Table `gogomoney03-02`.`income`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gogomoney03-02`.`income` (
  ...
  CONSTRAINT `in_category_fkey`
    ...
    REFERENCES `gogomoney03-02`.`category` (`category_id`),
  CONSTRAINT `in_user_fkey`
    FOREIGN KEY (`user_id`)
    REFERENCES `gogomoney03-02`.`user` (`user_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;


-- -----------------------------------------------------
-- Table `gogomoney03-02`.`outcome`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gogomoney03-02`.`outcome` (
