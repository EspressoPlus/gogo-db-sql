CREATE DATABASE  IF NOT EXISTS `gogomoney3.1` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gogomoney3.1`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: localhost    Database: gogomoney3.1
-- ------------------------------------------------------
...
CREATE TABLE `income` (
  ...
  `reccuring` varchar(25) DEFAULT 'FALSE',
  `reccur_interval` varchar(25) DEFAULT NULL,
